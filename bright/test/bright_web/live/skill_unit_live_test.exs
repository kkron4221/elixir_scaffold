defmodule BrightWeb.SkillUnitLiveTest do
  use BrightWeb.ConnCase

  import Phoenix.LiveViewTest
  import Bright.SkillUnitsFixtures

  @create_attrs %{loced_date: "2024-03-23T06:55:00", name: "some name", trace_id: 42}
  @update_attrs %{loced_date: "2024-03-24T06:55:00", name: "some updated name", trace_id: 43}
