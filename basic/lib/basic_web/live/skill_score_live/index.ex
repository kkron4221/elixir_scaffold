defmodule BasicWeb.SkillScoreLive.Index do
  use BasicWeb, :live_view

  alias Basic.SkillScores
  alias Basic.SkillScores.SkillScore
  ...
  @impl true
  def handle_info({BasicWeb.SkillScoreLive.FormComponent, {:saved, skill_score}}, socket) do
